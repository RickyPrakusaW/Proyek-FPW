...
function SideBar() {
    ...
    const getButtonClass = (buttonId) => {
        const baseClasses = "flex items-center space-x-3 p-3 rounded-md cursor-pointer";
        const activeClass = isDarkMode ? "bg-blue-600" : "bg-blue-400";
        const hoverClass = `hover:${buttonClasses}`;
        
        return `${baseClasses} ${activeButton === buttonId ? activeClass : ''} ${hoverClass}`;
    };

    return (
        <div className={`min-h-screen flex ${themeClasses}`}>
            <div className={`${isSidebarOpen ? "w-64" : "w-16"} h-screen ${sidebarClasses} p-5 transition-all duration-300`}>
                {/* Header */}
                ...
                <ul className="space-y-4">
                    ...
                    <li
                        ...
                        onClick={() => handleMenuClick('/kepalaGudang/stockGudang', 'stock')}
                    >
                        <span>📦</span>
                    ...
                    <li
                        ...
                        onClick={() => handleMenuClick('/kepalaGudang/addBarangMasuk', 'barangMasuk')}
                    >
                        <span>📋</span>
                    ...
                    <li
                        ...
                        onClick={() => handleMenuClick('/kepalaGudang/addBarangKeluar', 'barangKeluar')}
                    >
                        <span>📋</span>
                    ...
                    <li
                        ...
                        onClick={() => handleMenuClick('/kepalaGudang/returBarang', 'retur')}
                    >
                        <span>↩️</span>
